    ...
    vehicles_listings = [
        # 1. 현대 NF소나타 (기존 3D 모델 있는 차량)
        {
            "v": {"brand": "현대", "model": "NF소나타", "year": 2008, "trim": "트랜스폼 GLS",
                  ...
                  "thumbnail_url": "/static/images/cars/nf_sonata.jpg",
                  "model_3d_url": "/static/models/nf_sonata/model.ply", "model_3d_status": "ready"},
            ...
            "d": {"overall_score": 72, "exterior_score": 65, "interior_score": 75, "engine_score": 76,
                  "accident_history": "단순교환 1회 (좌측 펜더, 2015년)",
                  "estimated_price_low": 320, "estimated_price_high": 450,
                  "report_summary": "좌측 펜더 단순교환 1회 이력 (외판교환 분류, 골격손상 없음). 후방 휠하우스 미세 부식 관찰. 엔진 누유 없음, 잡소리 없음."},
            "seller": demo_user,
        },
        # 2. 현대 그랜저
        {
            "v": {"brand": "현대", "model": "그랜저", "year": 2022, "trim": "르블랑",
                  ...
                  "model_3d_url": "/static/models/car2_test/model.splat", "model_3d_status": "processing"},
        ...
        # 5. 제네시스 G80
        {
            ...
            "d": {"overall_score": 86, "exterior_score": 84, "interior_score": 88, "engine_score": 86,
                  "accident_history": "단순교환 1회 (후면 범퍼, 외판교환)",
                  "estimated_price_low": 4500, "estimated_price_high": 5200,
                  "report_summary": "후면 범퍼 단순교환 1회 (외판교환, 골격손상 아님). BSD·LDWS 정상 작동. 엔진 누유 없음."},
            "seller": seller4,
        },
        # 6. BMW 520i
        {
        ...
        # 12. 기아 카니발
        {
            ...
            "d": {"overall_score": 83, "exterior_score": 80, "interior_score": 82, "engine_score": 87,
                  "accident_history": "단순교환 1회 (후방 범퍼, 주차장 접촉)",
                  "estimated_price_low": 2600, "estimated_price_high": 3200,
                  "report_summary": "후방 범퍼 단순교환 1회 (외판교환). DPF 클리닝 6개월 내 권장 (누적 65,000km). 엔진 누유 없음, EGR 정상."},
            "seller": seller2,
        },
    ]
